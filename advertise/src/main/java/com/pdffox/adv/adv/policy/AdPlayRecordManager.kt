 ...
 * 全屏/Banner 广告播放记录管理器。
 *
 * 记录广告位展示时间，用于计算广告位频控和全局播放次数限制。
 */
object AdPlayRecordManager {

	private const val TAG = "AdPlayRecordManager"

	private val gson = Gson()
	private const val PREF_KEY = "ad_records_key"
	private const val PREF_LAST_LIMITED_TIME_KEY = "last_limited_time_key"
	...
	/** 从 SharedPreferences 恢复播放记录和限频时间。 */
	...
	/** 获取 startTime 到当前时间之间所有广告位的播放次数。 */
