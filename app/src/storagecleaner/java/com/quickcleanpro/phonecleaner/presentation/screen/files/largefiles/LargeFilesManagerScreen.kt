...
fun LargeFilesManagerScreen() {
    LargeFilesManagerScreenState(viewModel = koinViewModel())
}

@Composable
private fun LargeFilesManagerScreenState(viewModel: LargeFilesManagerViewModel) {
...
@Composable
private fun LargeFilesManagerContent(
    uiState: LargeFilesManagerUiState,
    showDetail: Boolean,
    ...
    Column(
        ...
        FileOperationPhaseContent(
            phase = uiState.phase,
            scanningText = stringResource(R.string.file_scanning_large_files),
