...
import com.quickcleanpro.phonecleaner.presentation.screen.files.common.components.FileManagerAudioListView
...
@Composable
private fun AudiosManagerContent(
    uiState: AudiosManagerUiState,
    showDetail: Boolean,
    ...
    Column(
        ...
        FileOperationPhaseContent(
            phase = uiState.phase,
            scanningText = stringResource(R.string.file_scanning_audios),
