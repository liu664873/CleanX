...
import com.quickcleanpro.phonecleaner.presentation.common.QuickCleanProPermissionCopy
import com.quickcleanpro.phonecleaner.presentation.common.QuickCleanProPermissionOverlay
import com.quickcleanpro.phonecleaner.presentation.common.QuickCleanProPermissionRequiredDialog
...
import com.quickcleanpro.phonecleaner.presentation.screen.applock.AppLockOverlayPermissionDialog
import com.quickcleanpro.phonecleaner.presentation.screen.applock.AppLockUsageAccessPermissionDialog

object QuickCleanProPermissionUi : VariantPermissionUi {
    @Composable
    override fun PermissionPrompt(
        ...
        when (request.missingPermission?.key) {
            ...
            CommonPermission.Overlay.key -> {
                ...
                QuickCleanProPermissionOverlay(onDismiss = onDismiss) {
                    QuickCleanProPermissionRequiredDialog(
...
private fun PermissionPromptRequest.copyForQuickCleanPro(): QuickCleanProPermissionCopy =
...
private fun copyFor(
    ...
    return when (action) {
        ...
        CleanXProtectedAction.VirusDeepScanStart -> QuickCleanProPermissionCopy(
            titleRes = titleRes,
        ...
        CleanXProtectedAction.NetworkUsageLoadStats -> QuickCleanProPermissionCopy(
            titleRes = titleRes,
...
private fun overlayCopy(): QuickCleanProPermissionCopy =
    QuickCleanProPermissionCopy(
...
private fun postNotificationsCopy(): QuickCleanProPermissionCopy =
    QuickCleanProPermissionCopy(
        titleRes = R.string.permission_title_required,
