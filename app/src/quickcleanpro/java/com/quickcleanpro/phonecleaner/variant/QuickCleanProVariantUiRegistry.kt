...
fun currentVariantUiRegistry(): VariantUiRegistry = QuickCleanProVariantUiRegistry

object QuickCleanProVariantUiRegistry : VariantUiRegistry {
    override val permissionUi: VariantPermissionUi = QuickCleanProPermissionUi
